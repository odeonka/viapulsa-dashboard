  ...
  <div>
    <div class="navbartop py-2 px-2 bg-white shadow d-flex justify-content-between">
      <div class="headinfo">
        ...
        <div class="ml-5">
          <router-link to="/analyst" class="btn mr-2 btn-primary">Transaksi Selesai <font-awesome-icon icon="arrow-right" class="mr-2" /></router-link>
          <!--
      ...
      <div class="card" style="height: calc(100vh - 32px)">
        <table class="table table-striped table-hover">
          <thead class="thead-dark">
            <tr>
              <th scope="col">ID</th>
              <th scope="col" class="text-center"><font-awesome-icon icon="globe" /></th>
          ...
          <tbody>
            ...
            <tr v-for="(trx, index) in filteredTrx" :key="index">
              ...
              <td>
                ...
                <div class="small text-white badge badge-primary">{{formatNominal(trx.nominal * trx.rate - trx.fee)}}</div>
              </td>
              <td>{{trx.rate}}</td>
              <td class="bank">
                <img v-if="trx.bank == 'BCA'" src="@/assets/img/bank/bank-bca.png" alt="">
                <img v-else-if="trx.bank == 'BNI'" src="@/assets/img/bank/bank-bni.png" alt="">
                <img v-else-if="trx.bank == 'BRI'" src="@/assets/img/bank/bank-bri.png" alt="">
                <img v-else-if="trx.bank == 'Mandiri'" src="@/assets/img/bank/bank-mandiri.png" alt="">

                <img v-else-if="trx.bank == 'OVO'" src="@/assets/img/bank/ovo.png" alt="">
                <img v-else-if="trx.bank == 'GoPay'" src="@/assets/img/bank/gopay.png" alt="">
                <img v-else-if="trx.bank == 'LinkAja'" src="@/assets/img/bank/linkaja.png" width="100px" alt="">
                <img v-else-if="trx.bank == 'Dana'" src="@/assets/img/bank/dana.png" alt="">
              ...
              <td><a v-if="trx.bukti_client_0 != null" target="_blank" type="button" :href="trx.bukti_client_0" class="btn btn-success">0</a></td>
              <td><a v-if="trx.bukti_server != null" target="_blank" type="button" :href="trx.bukti_server" class="btn btn-success">A</a></td>
    ...
    <transition name="fade">
      <div class="position-fixed" style="bottom:0px;right:0;z-index:999999">
        <div>
          <div class="caritransaksi" style='box-shadow: #dcdcdc -4px -3px 6px 1px;border: 2px solid #c3c3c3;border-top-left-radius: 16px;background: white;'>
          <input id="inputcari" style="padding: 0 16px 0 36px;margin: 8px;width: calc(100% - 68px);border: none;height: 35px;border-radius: 50px;color: rgba(0, 0, 0, 0.5);font-weight: 600;letter-spacing: 1px;" type="text" v-model="pencarian" placeholder="Cari data..."/>
            <div id="searchIcon position-absolute" style="position: absolute;top: 14px;left: 19px;"><font-awesome-icon icon="search" :style="{color: 'rgba(0,0,0,0.2)'}" /></div>
          </div>
        </div>
      </div>
    </transition>
...
export default {
  ...
  firestore () {
    return {
      transaksi: db.collection('trxconvert').orderBy('created', 'desc').limit(3000),
